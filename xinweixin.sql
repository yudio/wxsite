...
CREATE TABLE IF NOT EXISTS `tp_adma` (
  ...
  KEY `token` (`token`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='diy 宣传页' AUTO_INCREMENT=11 ;
...
CREATE TABLE IF NOT EXISTS `tp_call` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='手机短信配置' AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `tp_flash` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='3g网站头部flash' AUTO_INCREMENT=34 ;
...
CREATE TABLE IF NOT EXISTS `tp_follow` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='关注表' AUTO_INCREMENT=87 ;
...
(4, 4, 0, '朗读', 'langdu', '朗读＋关键词　例：朗读nicedog多用户营销系统', 1, 1),
...
CREATE TABLE IF NOT EXISTS `tp_host` (
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='酒店商家设置' AUTO_INCREMENT=17 ;
...
CREATE TABLE IF NOT EXISTS `tp_host_list_add` (
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='房间类型信息表' AUTO_INCREMENT=15 ;
...
CREATE TABLE IF NOT EXISTS `tp_host_order` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='订单管理' AUTO_INCREMENT=14 ;
...
CREATE TABLE IF NOT EXISTS `tp_img` (
  ...
  KEY `classid` (`classid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='微信图文' AUTO_INCREMENT=64 ;
...
--
-- 转存表中的数据 `tp_product_diningtable`
--
...
CREATE TABLE IF NOT EXISTS `tp_text` (
  ...
  PRIMARY KEY  (`id`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='文本回复表' AUTO_INCREMENT=124 ;
...
(8, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 5, 1, '', 1386819303, '127.0.0.1', '');
...
CREATE TABLE IF NOT EXISTS `tp_users` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='前台用户表' AUTO_INCREMENT=33 ;
...
CREATE TABLE IF NOT EXISTS `tp_wxuser` (
  ...
  KEY `uid` (`uid`),
  KEY `uid_2` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='微信公共帐号' AUTO_INCREMENT=59 ;
