...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/emotion.css?2014-02-20-1" media="all"/>
    ...
    <script type="text/javascript" src="<?php echo RES;?>/src/emotion.js?2014-02-20-1"></script>
...
<div class="box-title">
    <div class="span10">
        <h3><i class="icon-edit"></i>编辑文本自定义内容</h3>
    </div>
    <div class="span2"><a class="btn" href="Javascript:window.history.go(-1)">返回</a></div>
</div>

<div class="box-content">
<form action="/npManage/reply/addtext.act" method="post" class="form-horizontal form-validate">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" name="keyword" id="keyword" data-rule-required="true" data-rule-maxlength="100" value="<?php echo ($info["keyword"]); ?>"
               class="input-xlarge" title="多个关键词请用空格格开：例如: 美丽 漂亮 好看"><br>多个关键词请用空格格开：例如: 美丽 漂亮 好看
    </div>
</div>
<div class="control-group">
    ...
    <div class="controls">
        <label class="radio">
            <input id="radio1" type="radio" name="type" value="1" <?php if($info["type"] == 1): ?>checked="checked"<?php endif; ?> >
            完全匹配，用户输入的和此关键词一样才会触发!
        </label>
        <label class="radio">
            <input id="radio2" type="radio" name="type" value="2" <?php if($info["type"] == 2): ?>checked="checked"<?php endif; ?> >
...
<div class="editArea">
    <textarea name="text" id="content" style="display: none;" title="first tooltip"><?php echo ($info["text"]); ?></textarea>

    <div contenteditable="true" style="overflow-y: auto; overflow-x: hidden;"><?php echo ($info["text"]); ?></div>
</div>
</div>

<span class="maroon">*</span><span class="help-inline">必填, 用户添加您的时候自动回复语；超链接添加形式，如：&lt;a href="http://www.baidu.com"&gt;百度&lt;/a&gt;</span>
</div>
</div>
<div class="form-actions">
    <input type="hidden" name="id" id="aid" value="<?php echo ($info["id"]); ?>">
    <button type="submit" class="btn btn-primary" id="bsubmit">保存</button>
    <button type="button" class="btn" onclick="window.location='/npManage/addnews.act'">切换到图文模式</button>
