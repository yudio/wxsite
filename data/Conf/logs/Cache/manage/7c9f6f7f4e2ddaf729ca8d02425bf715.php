                    ...
                    <div class="box">
                        ...
                        <div class="box-content">
                                ...
                                <div class="pd">
                                    ...
                                    <form action="/npManage/account/bind.act" method="post" class="form-horizontal form-validate2">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="wxaccount" id="username" class="input-large" data-rule-required="true" data-rule-maxlength="60" />
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="password" name="wxpwd" id="password" class="input-large" data-rule-required="true" data-rule-maxlength="60" />
                                    ...
                                    <div class="f14 gray">
                                        帐号及密码仅限智能绑定使用，不保存！不泄漏！不放心？点此 <a href="/npManage/account/addwxuser.act">手动绑定</a>
                                    </div>
                                </div>
                            ...
                            <div class="bboxl step2 hide">
                                <div class="carousel">
                                    <img src="<?php echo RES;?>/img/binding/b1.jpg" />
                                </div>
                            </div>
                            <div class="bboxl step3 hide">
                                <div class="pd">
                                    <div class="end">
                                        ...
                                        <div class="mb30">
                                            <a class="btn btn-primary btn-large btn-zdy" id="gotomyaccount" href="npManage/account/index.act" target="_top">进入“微”世界</a>
                                        </div>
                                    ...
                                    <div class="mm">
                                        <img src="<?php echo RES;?>/img/binding/mm.jpg" />
            ...
            $from.validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        ...
                        success: function (d) {
                            btn.button('reset');
							//{"errno":0,"error":"信息","pid":69535}
                            if (d.errno == 0) {
								// 修改跳转链接
								var url = '/npManage/account/main.act';
                ...
                $op.onStop = function (v) {
                    ...
                    if ($step > 0 && v > 0) {
                        ...
                        $(".carousel img").fadeOut('fast', function () {
                            $(".carousel img").attr("src", ("<?php echo RES;?>/img/binding/b{0}.jpg".format($step + 1)));
                        });
