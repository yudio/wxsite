                                    ...
                                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td align="center">
                                            <p><?php if($_SESSION['gid']>1){echo $_SESSION['gid']-1;}else{echo 0;} ?>
                                                <a   href="#" id="smemberss" class="green"><em>升降级</em></a></p>
                                        ...
                                        <td>
                                            ...
                                            <a href="/npManage/account/detail.act?id=<?php echo ($vo['id']); ?>&token=<?php echo ($vo['token']); ?>" class="btn" rel="tooltip" title="编辑"><i
                                                    class="icon-edit"></i></a>
                                            <a href="javascript:G.ui.tips.confirm('您确定要删除此公众帐号吗?', '/npManage/account/delwxuser.act?id=<?php echo ($vo['id']); ?>');"
                                               class="btn" rel="tooltip" title="删除"><i class="icon-remove"></i></a>
                                            <a href="javascript:void(0)"
                                               onclick="parent.location.href='/npManage/microsite/main.act?id=<?php echo ($vo['id']); ?>&token=<?php echo ($vo['token']); ?>'" class="btn"
