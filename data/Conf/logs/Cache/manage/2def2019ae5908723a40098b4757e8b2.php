...
<div class="box-title">
    <div class="span12">
        <h3><i class="icon-cog"></i>編輯幻灯片</h3>
    </div>
</div>
<form action="/npManage/MicroSite/slide_update.act" method="post" class="form-horizontal form-validate">
<div class="box-content">
<div class="control-group">
    <label for="name" class="control-label">幻灯片名称：</label>

    <div class="controls">
        <input type="text" id="name" name="title" value="<?php echo ($info["title"]); ?>" class="input-medium" data-rule-required="true"/>
        <span class="maroon">*</span><span class="help-inline"></span>
    </div>
</div>
<div class="control-group">
    <label for="discription" class="control-label">幻灯片描述：</label>

    <div class="controls">
        <textarea id="description" name="desc" rows="2" class="input-xxlarge" data-rule-maxlength="20"
                  placeholder="最多20个字符"><?php echo ($info["desc"]); ?></textarea>
        <span class="maroon">*</span><span class="help-inline"></span>
    </div>
</div>
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" id="sort" name="sort" value="<?php echo ($info["sort"]); ?>" class="input-mini" data-rule-required="true"
...
<div class="control-group">
    ...
    <div class="controls">
        <label class="radio inline"><input type="radio" value="1" name="is_show" <?php if($info["is_show"] == '1'): ?>checked="checked"<?php endif; ?>/>显示</label>
        <label class="radio inline"><input type="radio" value="0" name="is_show" <?php if($info["is_show"] == '0'): ?>checked="checked"<?php endif; ?>/>隐藏</label>
    </div>
</div>
<div id="res_block">
    <div class="control-group">
    ...
    <div id="r_article" class="control-group r-module hide">
        <div class="control-group">
            ...
            <div class="controls choose">
                <span class="maroon">请选择图文</span>
													<span class="help-inline">
														<a href="javascript:void(0)" class="btn btn-mini ed_choose"><i
                                                                class="icon-edit"></i></a>
													</span>
            </div>
        </div>
    ...
    <div id="r_link" class="control-group r-module hide">
        <div class="control-group">
            ...
            <div class="controls">
                <input type="url" id="link" name="url" value="" class="input-xlarge" data-rule-required="true"
                       data-rule-url="true"/>
        ...
        <div class="modal-content">
            <form id="add_code" action="" method="post" class="form-horizontal">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="icon-table"></i>选择图文</h4>
                </div>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    ...
                    var _page = function (_index) {
                        ...
                        $.get("/wechat/votetouser", {"key": key, "classid": classid, "page": _index, "aid": 72040, "tid": 0}, function (data, textStatus) {
                            $("#data-list").html("");
...
<script>
    $(document).ready(function () {
        ...
        if (typeval){
            //$('select[name="type"]').attr('value',typeval);
            //alert($("select[name=type] option[value='"+typeval+"']").val());//.val();
