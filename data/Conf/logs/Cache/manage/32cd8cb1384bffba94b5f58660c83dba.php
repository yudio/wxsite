    ...
    <div class="span12">
        ...
        <script type="text/javascript">
            $("a.preview").click(function () {
                ...
                window.open("http://yudio.xicp.net/wechat.wx/vostqw1393042012?wechatid=fromUsername", "我的微官网", "height=650,width=450,top=0,left=" + left + ",toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no");
            });
        </script>
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <img class="thumb_img" src="<?php echo RES;?>/img/default/official.jpg?v=2014-02-17-2" style="max-height:100px;"/>
...
<div class="control-group">
    ...
    <div class="controls">
        <img class="gwbg thumb_img" src="<?php echo RES;?>/img/template/lib/home-default10.jpg?v=2014-02-20-1"
