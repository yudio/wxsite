...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo STATICS;?>/inside.css?2014-02-20-1" media="all"/>
                    ...
                    <div class="box-content">
                        <div class="row-fluid">
                            <div class="span8 control-group">
                                <a href="/npManage/microsite/addclass.act" class="btn"><i class="icon-plus"></i>添加分类</a>
                            </div>
                        </div>
                        <div class="row-fluid dataTables_wrapper">
                            <table id="listTable" class="table table-bordered table-hover dataTable">
                                ...
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="/npManage/microsite/editclass.act?id=<?php echo ($vo["id"]); ?>" class="btn">编辑</a><a
                                            href="javascript:G.ui.tips.confirm('确定要删除吗？', '/npManage/microsite/classify_del.act?id=<?php echo ($vo["id"]); ?>');"
                                            class="btn">删除</a></td>
                                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                <tr>
                                    <td>test2</td>
                                    <td><i class="icon-smile"></i></td>
                                    <td><span class="label label-satgreen">显示</span></td>
                                    <td>0</td>
                                    <td>图文</td>
                                    <td>图文列表</td>
                                    <td><a href="/microsite/addclass/aid/72040/cid/209427" class="btn">编辑</a><a
                                            href="javascript:G.ui.tips.confirm('确定要删除吗？', '/microsite/deleteclass/aid/72040/key/209427');"
                                            class="btn">删除</a></td>
                                </tr>
                            </table>
                        </div>
