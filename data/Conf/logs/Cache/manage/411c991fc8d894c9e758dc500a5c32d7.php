...
<form action="/npManage/MicroSite/slide_insert.act" method="post" class="form-horizontal form-validate">
<div class="box-content">
<div class="control-group">
    <label for="name" class="control-label">幻灯片名称：</label>

    <div class="controls">
        <input type="text" id="name" name="title" value="" class="input-medium" data-rule-required="true"/>
...
<div class="control-group">
    ...
    <div class="controls">
        <img type="img" src="<?php echo RES;?>/img/template/lib/default-slide.jpg?=2014-02-20-1" style="max-height:50px;"/>
        <input type="hidden" name="img" value="<?php echo RES;?>/img/template/lib/default-slide.jpg?=2014-02-20-1"
               class="input-medium"/>
...
<div class="control-group">
    ...
    <div class="controls">
        <label class="radio inline"><input type="radio" value="1" name="is_show" checked="checked"/>显示</label>
        <label class="radio inline"><input type="radio" value="0" name="is_show"/>隐藏</label>
    </div>
</div>
<div id="res_block">
    <div class="control-group">
