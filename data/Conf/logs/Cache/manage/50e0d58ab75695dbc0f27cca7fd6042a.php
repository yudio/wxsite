...
<div class="control-group">
    ...
    <div class="controls">
        <img type="img" src="img/template/lib/home-150150.jpg?v=2014-02-20-1?=2014-02-20-1" style="max-height:50px;"/>
        <input type="hidden" name="img" value="/img/template/lib/home-150150.jpg?v=2014-02-20-1?=2014-02-20-1"
               class="input-medium"/>
