...
关注时自动回复内容</h3>
					...
					<form action="/npManage/reply/subsnewsupdate.act" method="post" class="form-horizontal form-validate">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <input type="text" ata-rule-number="true" class="input-mini" value="<?php echo ($info["sort"]); ?>" size="3" name="sort"><span style="color:red;" class="help-inline">(id越大，在所属官网分类文章列表中显示越靠前)</span>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
											                                            <img id="thumb_img" src="<?php echo ($info["pic"]); ?>" style="max-height:100px; display:none;" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="description" name="info" data-rule-required="true" data-rule-maxlength="200" style="width: 580px; height: 100px"><?php echo ($info["info"]); ?></textarea><span class="maroon">*</span>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="title" class="control-label">所属类别：</label>
                                    <div class="controls">
                                        <select name="classid" class="chosen-select input-medium" data-nosearch="true" id="article_class">
                                           <option value="0" selected="selected">根分类</option>   </select>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label class="radio inline">
                                            <input type="radio" name="show_cover"  value="1" <?php if($info["showpic"] == 1): ?>checked="checked"<?php endif; ?> >
                                            是
                                        </label>
                                        <label class="radio inline">
                                            <input type="radio" name="show_cover" value="0" <?php if($info["showpic"] == 0): ?>checked="checked"<?php endif; ?> >
                                            否
                                        </label>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="reply_content" id="content" style="width: 700px; height: 300px; visibility: hidden;"><?php echo ($info["text"]); ?></textarea>
                                    </div>
                               ...
                               <div id="res_block">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select id="type" name="match_type" class="input-medium">
                                             <option value="0">请选择</option>
                                                ...
                                                <option value="vshop" >微商城</option>d
                                ...
                                <div class="form-actions">
                                    ...
                                    <input type="hidden" name="type" id="imgtype" value="3">
                                    <button type="submit" class="btn btn-primary" id="bsubmit">保存</button>
																		 <button type="button" class="btn" onclick="window.location='/wechat/replysubscribe/aid/72040'"> 切换到文字模式 </button>
