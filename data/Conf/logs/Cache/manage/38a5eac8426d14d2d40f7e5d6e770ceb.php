                ...
                <div class="span12">
                    <div class="box">
                        ...
                        <div class="box-content">
                            ...
                            <form action="/npManage/account/updateuser.act" method="post" class="form-horizontal form-validate">
                                <div class="control-group">
                                    <label for="name" class="control-label">商户名称：</label>
                                    <div class="controls">
                                        <input type="text" name="nickname" id="nickname" class="input-medium" value="<?php echo ($info['nickname']); ?>" data-rule-required="true" /><span class="maroon">*</span>
                                    </div>
                                </div>
                                <div class="control-group">
