        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box">
                    <div class="box-title">
                        <div class="span12">
                            <h3><i class="icon-table"></i>首页幻灯片</h3>
                    ...
                    <div class="box-content">
                        <div class="row-fluid">
                            <div class="span8 control-group">
                                <a href="/npManage/microsite/addslide.act" class="btn"><i
                                        class="icon-plus"></i>添加幻灯片</a>
                            </div>
                        </div>
                        <div class="row-fluid dataTables_wrapper">
                            <table id="listTable" class="table table-bordered table-hover dataTable">
                                ...
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        <img type="img" src="<?php echo ($vo["img"]); ?>"
                                             style="max-height:50px;"/>
                                    </td>
                                    <td><?php echo ($vo["type"]); ?></td>
                                    <td><?php echo ($vo["url"]); ?></td>
                                    <td>
                                        <?php if($vo["is_show"] == 1): ?><span class="label label-satgreen">显示</span><?php else: ?>隐藏<?php endif; ?>
                                    </td>
                                    <td>
                                        <a target="ddd" href="<?php echo U('Wap/Index/flash',array('token'=>$_SESSION['token']));?>">查看</a>
                                        <a href="/npManage/microsite/editslide.act?id=<?php echo ($vo["id"]); ?>" class="btn">编辑</a>
                                        <a href="javascript:G.ui.tips.confirm('确定要删除吗？', '/npManage/microsite/slide_del.act?id=<?php echo ($vo["id"]); ?>');"
                                           class="btn">删除</a>
                                    </td>
...
<script type="text/javascript">
    ...
    if (typeof(window.shareData) == 'undefined') {
        window.shareData = {
            "imgUrl": "",
            "timeLineLink": "http://www.weimob.com/microsite/slide?aid=72040",
            "sendFriendLink": "http://www.weimob.com/microsite/slide?aid=72040",
            "weiboLink": "http://www.weimob.com/microsite/slide?aid=72040",
