                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="article_class" class="chosen-select input-medium" data-nosearch="true" id="article_class">
                                           ...
                                           <?php if(is_array($classinfo)): $i = 0; $__LIST__ = $classinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>,<?php echo ($val["name"]); ?>" <?php if($val["id"] == $vo.id): ?>selected="selected"<?php endif; echo ($val["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                </div>
