...
<body>
    <div id="navigation">
        <div class="container-fluid">
            <div>
                <a href="/npManage/Account/main.act" target="_self" id="brand"></a>
                <a href="/npManage/Account/main.act" target="_self" class="toggle-nav" rel="tooltip" data-placement="bottom" title="Toggle navigation"><i class="icon-reorder"></i></a>
            </div>
            <ul class='main-nav'>
                <li class='active'>
                    <a href="/npManage/Account/main.act" target="_self">
                        <span>管理平台</span>
                    </a>
                </li>
                ...
                <li><a href="javascript:void(0)" data-toggle="dropdown" class='dropdown-toggle' data-hover="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="http://wpa.qq.com/msgrd?v=3&uin=24757856&site=qq&menu=yes" target="_blank">在线客服</a></li>
    ...
    <div class="container-fluid" id="content">
        <div id="left">
            <div class="subnav">
                ...
                <ul class="subnav-menu" style="display: block">
                    ...
                    <li>
                        <a href="/npManage/account/chgpwd.act">修改密码</a>
                    </li>
                    <li class="active">
        ...
        <div class="right">
            <div class="main">
                ...
                <iframe frameborder="0" id="mainFrame" name="mainFrame" src="/npManage/Account/index.act" style="background: url('<?php echo RES;?>/img/loading.gif') center no-repeat"></iframe>
