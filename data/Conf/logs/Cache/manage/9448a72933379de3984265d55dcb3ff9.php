...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/bootstrap_min.css?2014-02-19-2" media="all" />
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/bootstrap_responsive_min.css?2014-02-19-2" media="all" />
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/style.css?2014-02-19-2" media="all" />
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/todc_bootstrap.css?2014-02-19-2" media="all" />
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/themes.css?2014-02-19-2" media="all" />
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/inside.css?2014-02-19-2" media="all" />
<script type="text/javascript" src="<?php echo RES;?>/src/jQuery.js?2014-02-19-2"></script>
<script type="text/javascript" src="<?php echo RES;?>/src/plugins/fileupload/bootstrap_fileupload_min.js?2014-02-19-2"></script>
<script type="text/javascript" src="<?php echo RES;?>/src/bootstrap_min.js?2014-02-19-2"></script>
<script type="text/javascript" src="<?php echo RES;?>/src/plugins/validation/jquery_validate_min.js?2014-02-19-2"></script>
<script type="text/javascript" src="<?php echo RES;?>/src/plugins/validation/jquery_validate_methods.js?2014-02-19-2"></script>
<script type="text/javascript" src="<?php echo RES;?>/src/plugins/form/jquery_form_min.js?2014-02-19-2"></script>
<script type="text/javascript" src="<?php echo RES;?>/src/region_select.js?2014-02-19-2"></script>
<script type="text/javascript" src="<?php echo STATICS;?>/inside.js?2014-02-19-2"></script>
                ...
                <div class="box">
                    ...
                    <div class="box-content">
                        <div id="validateErrorContainer" class="validateErrorContainer ">
                            <h5>要手动绑定？不体验智能绑定的乐趣？<a href="/npManage/account/autobind.act">立即使用</a></h5>
                        ...
                        <form action="/npManage/account/addwxuser.act" method="POST" class="form-horizontal form-validate">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="wxid" id="plc_sourceid" class="input-medium" data-rule-required="true" value="" ><span class="maroon">*</span><span class="help-inline">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="weixin" id="wechat_id" class="input-medium" data-rule-required="true" value=""><span class="maroon">*</span>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input id="thumb" type="text" name="headerpic" value="" class="input-xlarge" readonly data-rule-required="true" data-rule-url="true" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="wxaccount" value="" id="email" class="input-medium" data-rule-email="true">
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="funs" class="control-label">粉丝数：</label>
                                <div class="controls">
                                    <input type="text" name="wxfans" value="" id="funs" class="input-medium">
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group hide">
                                ...
                                <div class="controls">
                                    <input type="text" name="tongji"  value="" id ="code_stat" style="width: 600px; height: 40px;" maxlength="300">
                                </div>
                            </div>
