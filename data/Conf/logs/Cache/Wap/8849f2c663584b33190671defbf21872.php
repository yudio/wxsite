...
<link type="text/css" rel="stylesheet" href="<?php echo RES;?>/css/ktv/style01.css">
<link rel="stylesheet" href="<?php echo RES;?>/css/flash/css/plugmenu.css">
<script type="text/javascript" charset="utf-8" src="<?php echo RES;?>/js/ktv/page_context.js"></script>
...
<div>
	<ul class="mainmenu2 radius margin10">
		...
		<?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="radius_top border-top-none">
			<div class="menubtn">
			...
			<a href="<?php echo U('Index/content',array('id'=>$vo['id'],'token'=>$vo['token']));?>"><?php endif; ?>
				...
				<p class="menudesc"><?php echo ($vo["text"]); ?></p>
