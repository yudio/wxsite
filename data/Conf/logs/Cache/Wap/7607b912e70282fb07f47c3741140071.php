...
<?php if($Coupon['end'] == 1): ?><div class="main">
		<div class="banner">
			<img src="<?php echo RES;?>/css/guajiang/images/activity-coupon-null.jpg">
		</div>
		<div class="content" style="margin-top:-5px">
			<div class="boxcontent boxwhite">
				<div class="box">
					<div class="title-brown">木有优惠券了</div>
					<div class="Detail">
						<p><?php echo ($Coupon["msg"]); ?></p>
					</div>
				</div>
			</div>
		</div>
...
<?php else: ?> <!--有优惠券的情况下-->
	...
	<?php if($Coupon['end'] == 2): ?><!--过期-->
		<div class="main">
			<div class="banner">
					<img src="<?php echo RES;?>/css/guajiang/images/activity-coupon-end.jpg">
			</div>
			<div class="content" style="margin-top:-5px">
				<div class="boxcontent boxwhite">
					<div class="box">
	...
	<?php else: ?><!---->
		...
		<?php if($Coupon['end'] == 3): ?>
			<div class="main">
				<div class="cover">
					<img  src="<?php echo RES;?>/css/guajiang/images/activity-coupon-win.jpg">
				</div>
				<div class="boxcontent boxwhite">
						<div class="box">
							<div class="title-brown"> <span>我的优惠券</span> </div>
							<div class="Detail">
							 <p><span class="red"><?php echo ($Coupon["wxname"]); ?></span> - <?php echo ($Coupon["msg"]); ?></p>
							 <p>优惠券名称: <span class="red"><?php echo ($Coupon["myprize"]); ?></span></p>
							 <p>优惠券SN码: <span class="red"><?php echo ($Coupon["sn"]); ?></span></p>
		...
		<!--else/--> <!--没有领过-->
			<div class="main">
				<div class="cover" id="Conponid">
					<img id="winaprize" src="<?php echo RES;?>/css/guajiang/images/activity-coupon-start.jpg">
				...
				<div id="zjl" style="display:none" class="boxcontent boxwhite">
					<div class="box">
						...
						<div class="Detail">
							...
							<p>优惠券SN码: <span class="red"><?php echo ($Coupon["sncode"]); ?> </span></p>
							<p class="red"><?php echo ($Coupon["aginfo"]); ?></p>
							<p>
					...
					<div class="boxcontent boxwhite">
						<div class="box">
							...
							<p> 每人最多允许抽奖次数:<?php echo ($Coupon["canrqnums"]); ?> - 已抽取<span id="usenums"><?php echo ($Coupon["usenums"]); ?></span>次</p>
							 	<p>优惠券类型1: <?php echo ($Coupon["fist"]); ?> <if condition="$Coupon['displayjpnums'] eq 1">数量:<?php echo ($Coupon["fistnums"]); endif; ?></p>
							<?php if($Coupon['second'] != ''): ?><p>优惠券类型2: <?php echo ($Coupon["second"]); ?> <if condition="$Coupon['displayjpnums'] eq 1">数量:<?php echo ($Coupon["secondnums"]); endif; ?></p><?php endif; ?>
							 <?php if($Coupon['third'] != ''): ?><p>优惠券类型3: <?php echo ($Coupon["third"]); ?> <?php if($Coupon['displayjpnums'] == 1): ?>数量:<?php echo ($Coupon["thirdnums"]); endif; ?></p><?php endif; ?>
							</div>
						</div>
					</div>
					<div class="boxcontent boxwhite">
						<div class="box">
							...
							<div class="Detail"><?php echo ($Coupon["info"]); ?>
...
function Onloadok()
{
	...
	if(zjl&&goon){
		document.getElementById('winaprize').src="<?php echo RES;?>/css/guajiang/images/activity-coupon-winning.jpg";
		goon = false;
		$("#zjl").slideToggle(500);
	}
}
