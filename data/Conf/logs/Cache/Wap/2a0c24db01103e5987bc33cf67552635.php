    ...
    <div id="card" class="card" style="background:url('<?php echo ($card["diybg"]); ?>') no-repeat 0 0;-webkit-background-size:267px 159px;background-size:267px 159px;">
		  ...
		  <strong class="pdo verify" style="">
				<span style="color:#847d64;text-shadow:0 1px #ebe9e0;">
					...
					<span style="color:<?php echo ($card["numbercolor"]); ?>"><?php echo ($mycard["number"]); ?></span>
				</span>
		  </strong>
	  </div>
	  <!--会员卡背面-->
	  <div id="card2" class="card" style="background:url('<?php echo ($card["bg"]); ?>') no-repeat 0 0;-webkit-background-size:267px 159px;background-size:267px 159px;display:none">
		  <img src="<?php echo ($card["logo"]); ?>" class="logo"/>
		  <h1 style="color:<?php echo ($card["vipnamecolor"]); ?>;text-shadow:0 1px #e2ded2;"><?php echo ($card["cardname"]); ?></h1>
		  <!--<h2></h2>-->
		  <div style="padding-top:50px;color:#847d64;font-size:12px;margin-left:10px;"><span style="color:<?php echo ($card["vipnamecolor"]); ?>">总店电话：<?php echo ($contact["tel"]); ?></span><p></p>
