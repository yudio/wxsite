...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo RES;?>/css/119/iscroll.css" rel="stylesheet" type="text/css" />
    ...
    <body id="cate2">
			   <div class="banner">
		<div id="wrapper" style="height:258px;">
			<div id="scroller">
				<ul id="thelist"> 
        ...
        <div id="todayList">
            <ul class="todayList">
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="only2" style="background:#da0271;margin:0px;;oadding:0px;border-bottom:1px #fff solid;"  >
                        <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>">
                            <h2 class="menutitle" style="text-align:center;color:#fff;margin-left:30px;"><?php echo ($vo["name"]); ?> >></h2>
                        </a>
