...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo RES;?>/css/allcss/cate18_0.css" rel="stylesheet" type="text/css" />
            ...
            <ul> 
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>">
                        <img style="float:right;margin-right:10px;margin-top:5px;" src="<?php echo ($vo["img"]); ?>" /><div style="display:block;width:40px;height:50px;float:left;margin-left:5px;margin-top:50px;" ><div id="aa" style="display:block;width:40px;height:50px;"><?php echo ($vo["name"]); ?></div></div>
                    </a>
