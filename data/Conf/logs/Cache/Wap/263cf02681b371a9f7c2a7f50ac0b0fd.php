...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		/>
		<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/yuesh/wz04.css"
		/>
	...
	<body>
		<div class="banner">
			...
			<div id="nav">
				...
				<ul id="indicator">
					<?php if(is_array($flash)): $i = 0; $__LIST__ = $flash;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><li <?php if($i == 1): ?>class="active"<?php endif; ?>
							><?php echo ($i); ?>
						</li><?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
		...
		<script src="<?php echo RES;?>/css/flash/js/zepto.min.js" type="text/javascript">
		</script>
		<script src="<?php echo RES;?>/css/flash/js/plugmenu.js" type="text/javascript">
		</script>
		<div style="display:none">
		</div>
		<div class="copyright">
