...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <style>
    ...
    <body id="cate16">
        <div class="mainbg">
                <?php if(is_array($flash)): $i = 0; $__LIST__ = $flash;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><img src="<?php echo ($so["img"]); ?>" /><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
        <div id="insert1"></div>
        <div class="mainmenu">
            <ul>
