...
<script type="text/javascript" src="<?php echo RES;?>/css/guajiang/js/jquery.js"></script> 
<script type="text/javascript">window.jQuery || document.write('<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js">\x3C/script>')</script>

<div class="main">
<div class="cover">
 <?php if($cardset['qiandao'] != false): ?><img src="<?php echo $cardset['qiandao'];?>">
 <?php else: ?>
   <img src="<?php echo RES;?>/images/cart_info/qiandao.jpg"><?php endif; ?>

</div>
<div class="cover">
  <?php if($signined == 1): ?><img src="<?php echo RES;?>/images/cart_info/qiandaook.png">
  <?php else: ?>
 <form action="" method="post" accept-charset="utf-8">   
     <input class="pxbtn" name="sign-btn"  id="sign-btn" type="submit" value="点击这里签到赚积分">
 </form><?php endif; ?>
...
<div class="content"> 
  <div class="boxcontent boxwhite">
    <div class="box">
      <table border="0"  align="center" cellSpacing="0" cellPadding="0" width="100%" >
        ...
        <tbody>
          <tr align="middle">
            <td><?php echo ($userinfo['total_score']); ?></td>
  ...
  <div class="boxcontent boxwhite">
    <div class="box">
      <div class="day-brown">连续签到<font color='red'><?php echo ($userinfo['continuous']); ?></font>天,连续签到<strong>6</strong>天奖励<strong><?php echo $cardset['continuation'];?></strong>积分.</div>
      <div class="Detail">
        <table border="0" cellSpacing="0" cellPadding="0" width="100%"  align="center" >
        <thead >
          <tr align="middle" class="thistr">
            <th><strong>签到日期</strong></th>
            <th><strong>签到情况</strong></th>
        ...
        <tbody>
          <?php if(is_array($sign)): $i = 0; $__LIST__ = $sign;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr align="middle">
              ...
              <td><?php if($list["is_sign"] == 1): ?><img src="<?php echo RES;?>/images/cart_info/signed.png"><?php else: ?>未签<?php endif; ?></td>
...
$("#sign-btn").bind("click",
  function() {
   ...
   var btn   = $(this);    
    ...
    $.post('index.php?g=Wap&m=Signscore&a=signin&token=<?php echo ($_GET['token']); ?>&wecha_id=<?php echo ($_GET['wecha_id']); ?>', submitData,
      function(data) {
