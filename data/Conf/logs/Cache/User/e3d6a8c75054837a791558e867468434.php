     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        ...
        <td><input type="text" name="logourl" value="<?php echo ($set["logourl"]); ?>" id="pic" class="px" style="width:400px;"  readonly="readonly"/><span class="ke-button-common" id="upload" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="Upload"></span></td> 
       </tr>
       <tr> 
       ...
       <tr> 
        ...
        <TR>
                  ...
                  <TD><textarea name="content" id="text-content"  rows="5" style="width:590px;height:360px"><?php echo ($set["content"]); ?></textarea></TD>
                </TR>  
       <tr>         
       <th>&nbsp;</th>
       <td>
