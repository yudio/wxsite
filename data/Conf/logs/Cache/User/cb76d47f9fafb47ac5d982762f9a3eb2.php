...
<div class="content" style="width:920px; background:none; margin-left:275px; border:none; margin-bottom:30px;" >
  ...
  <div class="cLineB">
            当前活动并未开始，尚未生成SN吗，点击开始活动后，将生产SN码! 本次活动优惠券总数：<span class="redamount"><?php echo ($datacount); ?></span>个　　　已领取人数：<span class="redamount"><?php echo ($recordcount); ?> </span>个　　已领取奖品：<span class="redamount">0</span>个          </div>
  <div class="cLine" style=" padding: 8px 0">
         ...
         <TBODY>
                ...
                <td><?php if($record['sendtime'] == 0): else: echo (date('Y-m-d H:i:s',$record["sendtime"])); endif; ?>
    						...
    						<td>
               <?php if($record['sendstutas'] == 0): ?><a href="index.php?g=User&m=Coupon&a=sendprize&id=<?php echo ($record["id"]); ?>">发奖</a>
              <?php else: ?>
               <a href="index.php?g=User&m=Coupon&a=sendnull&id=<?php echo ($record["id"]); ?>">取消发奖</a><?php endif; ?>
