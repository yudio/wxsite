...
<script>
 ...
 <div class="content" style="width:920px; background:none; margin-left:275px; border:none; margin-bottom:30px;" >
          <div class="cLineB"><h4>编辑幻灯片</h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a></div> 
<div class="msgWrap">
  <form class="form" method="post"   action="<?php echo U('Flash/upsave');?>"  target="_top" enctype="multipart/form-data" >
...
<TR>
  <TH valign="top"><label for="pic">上传本地图片：</label></TH>
  <TD><input type="text" class="px" id="pic" value="<?php echo ($info["img"]); ?>" value="" name="img" style="width:500px"  readonly="readonly"><span class="ke-button-common" id="upload" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="Upload"></span><br />
  </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
  <TH valign="top"><label for="keyword">幻灯片链接地址 ：</label></TH>
  <TD><input type="input" class="px" id="keyword" value="<?php echo ($info["url"]); ?>" name="url" style="width:500px" ><br />
                   </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
