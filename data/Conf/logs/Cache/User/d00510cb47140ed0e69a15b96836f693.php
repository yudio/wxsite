          ...
          <div class="cLine">
			<div class="pageNavigator left">
				<a href="<?php echo U('Member_card/privilege',array('token'=>$token));?>" title="查看会员特权" class="btnGrayS vm bigbtn">
					<img src="<?php echo RES;?>/images/cart_info/power1.png" width="24px" class="vm">查看会员特权
				</a>
			　<a href="<?php echo U('Member_card/coupon',array('token'=>$token));?>" title="查看优惠券" class="btnGrayS vm bigbtn">
				...
				<a class="btnGrayS vm bigbtn" href="<?php echo U('Member_card/integral_add',array('token'=>$token));?>" title="发布礼品券">
              ...
              <tbody>
                <?php if(is_array($data_vip)): $i = 0; $__LIST__ = $data_vip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data_vip): $mod = ($i % 2 );++$i;?><tr>
					  ...
					  <td class="norightborder">
						<!--a href="">使用统计</a--> 
						<a href="<?php echo U('Member_card/integral_edit',array('id'=>$data_vip['id']));?>">编辑</a> <a href="<?php echo U('Member_card/integral_del',array('id'=>$data_vip['id']));?>">删除</a>
					  </td>
