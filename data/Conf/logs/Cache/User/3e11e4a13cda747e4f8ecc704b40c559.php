...
<TR>
  ...
  <TD rowspan="7" valign="top">
	  <div style="margin-left:20px">
		<img id="pic" src="<?php if($vo['starpicurl'] == ''): echo RES;?>/images/img/activity-scratch-card-start.jpg<?php else: echo ($vo["starpicurl"]); endif; ?>" width="373px" >
		<br />
		<input class="px"  name="starpicurl" value="<?php if($vo['starpicurl'] == ''): echo C('site_url');?>/tpl/User/default/common/images/img/activity-scratch-card-start.jpg<?php else: echo ($vo["starpicurl"]); endif; ?>"   onclick="document.getElementById('pic').src=this.value;" style="width:363px;"  />
  		...
  		<tbody>
  			<tr>
  				...
  				<td><input type="input" class="px" id="endtite" value="<?php if($vo['endtite'] == ''): ?>刮刮卡活动已经结束了<?php else: echo ($vo["endtite"]); endif; ?>" name="endtite" style="width:400px" />
  					<br />
  					请不要多于50字! </td>
  				<td rowspan="4" valign="top"><div style="margin-left:20px"><img  id="end" src="<?php if($vo['endpicurl'] == ''): echo C('site_url');?>/tpl/User/default/common/images/img/activity-scratch-card-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  width="373px"/> <br />
  					<input class="px"  name="endpicurl" value="<?php if($vo['endpicurl'] == ''): echo C('site_url');?>/tpl/User/default/common/images/img/activity-scratch-card-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  onchange="document.getElementById('end').src=this.value;"  style="width:363px;"  />
  					<br />
  					填写活动结束图片网址 </div></td>
  				</tr>
  			<tr>
