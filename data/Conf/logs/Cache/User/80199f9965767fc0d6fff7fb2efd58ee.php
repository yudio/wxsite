  		...
  		<tbody>
  			<tr>
  				...
  				<td><input type="input" class="px" id="endtite" value="<?php if($vo['endtite'] == ''): ?>砸金蛋活动已经结束了<?php else: echo ($vo["endtite"]); endif; ?>" name="endtite" style="width:400px" />
  					<br />
  					请不要多于50字! </td>
  				<td rowspan="4" valign="top"><div style="margin-left:20px"><img  id="end" src="<?php if($vo['endpicurl'] == ''): echo C('site_url');?>/tpl/User/default/common/images/img/activity-zadan-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  width="373px"/> <br />
  					<input class="px"  name="endpicurl" value="<?php if($vo['endpicurl'] == ''): echo C('site_url');?>/tpl/User/default/common/images/img/activity-zadan-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  onchange="document.getElementById('end').src=this.value;"  style="width:363px;"  />
  					<br />
  					填写活动结束图片网址 </div></td>
  				</tr>
  			<tr>
