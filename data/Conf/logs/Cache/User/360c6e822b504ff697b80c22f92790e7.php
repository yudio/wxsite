...
<div class="content" style="width:920px; background:none; margin-left:275px; border:none; margin-bottom:30px;" >
	  ...
	  <div class="cLineB">
		  <h4 class="left">留言列表</h4>
		  <div class="clr"></div>
	  </div>
	<!--tab start-->
	<div class="tab">
	<ul>
	<li class="tabli current" id="tab0"><a href="<?php echo U('Liuyan/index',array('token'=>$token));?>">留言管理</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Reply_info/set',array('token'=>$token,'infotype'=>'Liuyan'));?>">回复配置</a></li>
	</ul>
	</div>
	<!--tab end-->  
          <div class="cLine">
              <div class="pageNavigator left">
  <a href="<?php echo U('Liuyan/add');?>" title='新增留言信息' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/pic.png" class="vm" />新增留言</a>　
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              <THEAD>
                <TR>
					...
					<TH class="keywords">用户名</TH>
					<TH class="answer">留言</TH>
                    <TH  class="category" >回复</TH>
                    <TH class="time">留言时间</TH>
					<TH class="edit norightborder">回复时间</TH>
              ...
              <TBODY>
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><div class="cateimg"><?php echo ($vo["text"]); ?></div></td>
                  <td><?php echo ($vo["re"]); ?></td>
                  <td><?php if($vo['createtime'])echo date('Y-m-d',$vo['createtime']); ?></td>
                   
                   <td class="norightborder"><?php if($vo['uptatetime'])echo date('Y-m-d',$vo['uptatetime']); ?></td>
                   <td class="norightborder">
				   <a href="<?php echo U('Liuyan/edit',array('id'=>$vo['id']));?>" title="编辑图文自定义回复">回复</a>
				   <a href="<?php echo U('Liuyan/del',array('id'=>$vo['id']));?>">删除</a></td>
