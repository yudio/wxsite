...
<div class="content" style="width:920px; background:none; margin-left:275px; border:none; margin-bottom:30px;" >
  ...
  <div class="cLineB">
             本次活动奖品总数：<span class="redamount"><?php echo ($datacount); ?></span>个　　　中奖人数：<span class="redamount"><?php echo ($recordcount); ?> </span>个　　已领取奖品：<span class="redamount"><?php echo $sendCount;?></span>个          </div>
          ...
          <input name="delall"  type="hidden" value="" />
           <input name="wxid"  type="hidden" value="" />
            ...
            <td><?php if($record['sendtime'] == 0): else: echo (date('Y-m-d H:i:s',$record["sendtime"])); endif; ?>
						...
						<td>
               <?php if($record['sendstutas'] == 0): ?><a href="index.php?g=User&m=Guajiang&a=sendprize&id=<?php echo ($record["id"]); ?>">发奖</a>
              <?php else: ?>
               <a href="index.php?g=User&m=Guajiang&a=sendnull&id=<?php echo ($record["id"]); ?>">取消发奖</a><?php endif; ?>
