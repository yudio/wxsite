...
<div class="cLineB">
<h4 class="left">祝福列表 (<?php echo ($page); ?>) </h4>
...
<td class="norightborder"><a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Xitie/delinfos',array('id'=>$item['id'],'token'=>$token));?>');">删除</a></td>
...
<div class="pages"><?php echo ($page); ?>&nbsp;总参与人数：<?php echo ($num); ?>人</div>
</div>
<div class="clr"></div>
</div>
</div>
