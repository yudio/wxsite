...
<TR>
  ...
  <TD>
	...
	<input type="input" class="px" id="keyword" value="<?php if($vo['keyword'] == ''): ?>大转盘<?php else: echo ($vo["keyword"]); endif; ?>" name="keyword" style="width:350px" ><br />
  	<span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
  </TD>
  <TD rowspan="7" valign="top">
	  <div style="margin-left:20px">
		<img id="pic" src="<?php if($vo['starpicurl'] == 0): echo C('site_url');?>/tpl/Wap/default/common/css/guajiang/images/activity-lottery-start.jpg<?php else: echo ($vo["starpicurl"]); endif; ?>" width="373px" >	
		<br />
		<input class="px"  name="starpicurl" value="<?php echo C('site_url');?>/tpl/Wap/default/common/css/guajiang/images/activity-lottery-start.jpg"   onclick="document.getElementById('pic').src=this.value;" style="width:363px;"  />
		<br />
		填写活动开始图片网址
	  </div>
  </TD>
...
<TR>
  ...
  <TD>
	<input type="input" class="px" id="title" value="<?php if($vo['title'] == ''): ?>幸运大转盘活动开始了<?php else: echo ($vo["title"]); endif; ?>" name="title" style="width:350px" />
  	<br />
  	请不要多于50字!
  </TD>
  <TR>
  	...
  	<td>
		<input type="input" class="px" id="txt" value="<?php if($vo['txt'] == ''): ?>兑奖请联系我们，电话18950099999<?php else: echo ($vo["txt"]); endif; ?>" name="txt" style="width:350px" />
  		<br />请不要多于100字! 这个设定但用户输入兑奖时候的显示信息!
	</td>
  </TR>
 <TR>
  	<th valign="top"><span class="red">*</span>中奖提示：</th>
  	<td><textarea class="px" id="sttxt"  name="sttxt" style="width:350px"  ><?php echo ($vo["sttxt"]); ?></textarea> 中奖后,提示信息
  		 </td>
</TR>
<TR>
...
<td><textarea  class="px" id="info" name="info"  style="width:350px; height:125px" ><?php if($vo['info'] == ''): ?>亲，请点击进入大转盘抽奖活动页面，祝您好运哦！<?php else: echo ($vo["info"]); endif; ?></textarea><br />换行请输入
 &lt;br&gt;
 </td>
</TR>
<TR>
<th><span class="red">*</span>重复抽奖回复：</th>
<td><input type="input" class="px" id="aginfo" value="<?php if($vo['aginfo'] == ''): ?>亲，继续努力哦！<?php else: echo ($vo["aginfo"]); endif; ?>" name="aginfo" style="width:350px" />备注：
  	...
  	<table class="userinfoArea" style=" margin: 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
  		<tbody>
  			<tr>
  				...
  				<td><input type="input" class="px" id="endtite" value="<?php if($vo['endtite'] == ''): ?>幸运大转盘活动已经结束了<?php else: echo ($vo["endtite"]); endif; ?>" name="endtite" style="width:350px" />
  					<br />
  					请不要多于50字! </td>
  				<td rowspan="4" valign="top"><div style="margin-left:20px"><img  id="end" src="<?php if($vo['endpicurl'] == 0): echo C('site_url');?>/tpl/Wap/default/common/css/guajiang/images/activity-lottery-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  width="373px"/> <br />
  					<input class="px"  name="endpicurl" value="<?php echo C('site_url');?>/tpl/Wap/default/common/css/guajiang/images/activity-lottery-end.jpg"  onchange="document.getElementById('end').src=this.value;"  style="width:363px;"  />
  					<br />
  					填写活动结束图片网址 </div></td>
  				</tr>
  			<tr>
  				<th valign="top">活动结束说明：</th>
  				<td valign="top"><textarea  class="px" id="endinfo" name="endinfo"  style="width:350px; height:125px" ><?php if($vo['endinfo'] == ''): ?>亲，活动已经结束，请继续关注我们的后续活动哦。<?php else: echo ($vo["endinfo"]); endif; ?></textarea><br />换行请输入
 &lt;br&gt;
  				  </td>
  				</tr>
  			</tbody>
...
<TR>
	...
	<td><input class="radio" type="radio" name="remind" value="1"  <?php if($vo['remind'] == 1): ?>checked<?php endif; ?> >发送  <input class="radio" type="radio" name="remind" value="0"  <?php if($vo['remind'] == 0): ?>checked<?php endif; ?>>不发送</td> 
</TR> 
<TR>
<th>&nbsp;</th>
