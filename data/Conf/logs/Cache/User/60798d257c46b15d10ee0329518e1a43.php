     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        ...
        <td><input type="text" name="ppicurl" id="pic" value="<?php echo ($set["ppicurl"]); ?>" class="px" style="width:400px;" readonly="readonly"/><span class="ke-button-common" id="upload" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="Upload"></span> 填写图片外链地址，推荐大小为720x400</td> 
       </tr> 
       <tr> 
        <th><span class="red">*</span>订单页头部图片：</th> 
        <td><input type="text" name="headpic" value="<?php if($set["headpic"] != false): echo ($set["headpic"]); else: echo RES;?>/images/cart_info/online.jpg<?php endif; ?>" class="px" style="width:400px;" /> 不会自定义请留空:填写图片外链地址，推荐大小为720x125，高度可根据自身需求调整。<br />不填默认本图片: <a target="ss" href="<?php echo C('site_url');?>/tpl/User/default/common/images/cart_info/online.jpg">点击查看</a> </td> 
       </tr> 
