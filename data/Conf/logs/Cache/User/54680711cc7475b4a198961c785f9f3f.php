          ...
          <input name="delall"  type="hidden" value="" />
           <input name="wxid"  type="hidden" value="" />
            ...
            <td><?php if($record['sendtime'] == 0): else: echo (date('Y-m-d H:i:s',$record["sendtime"])); endif; ?>
						...
						<td>
               <?php if($record['sendstutas'] == 0): ?><a href="index.php?g=User&m=zadan&a=sendprize&id=<?php echo ($record["id"]); ?>">发奖</a>
              <?php else: ?>
               <a href="index.php?g=User&m=zadan&a=sendnull&id=<?php echo ($record["id"]); ?>">取消发奖</a><?php endif; ?>
