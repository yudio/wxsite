...
<div class="content" style="width:920px; background:none; margin-left:275px; border:none; margin-bottom:30px;" >
          ...
          <div class="msgWrap">
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
                  <th><span class="red">*</span>公众号账号：</th>
                  <td><input type="text" required="" class="px" name="wxaccount" value="" tabindex="1" size="25">
                  </td>
                </tr>
                <tr>
                    <th><span class="red">*</span>公众号密码：</th>
                    <td><input type="password" required="" class="px" name="wxpwd" value="" tabindex="1" size="25">
                    </td>
                </tr>
              </thead>
              <tbody>
                ...
                <tr style="display:none">
                  ...
                  <td><input type="text" name="token" value="<?php echo ($tokenvalue); ?>" class="px" tabindex="1" size="40">(填写你的公众号)例：nicedogweixin,请勿填写文,或者其它特殊字符，此处token和腾讯平台必须一致!</td>
                </tr>
