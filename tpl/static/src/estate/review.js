...
//        });
        $.ajax({
            url: '/WebEstate/'+WXUID+'/impressData?eid='+EID+'&wecha_id='+WECHATID,
            dataType: 'jsonp'
        });
    },
...
//            });
            $.ajax({
                url: '/WebEstate/'+WXUID+'/Userreview?eid='+EID+'&wechatid='+WECHATID+'&'+$.param(data),
                dataType: 'jsonp'
            });
        }
    },
...
//        });
        $.ajax({
            url: '/WebEstate/'+WXUID+'/expertData?eid='+EID+'&wecha_id='+WECHATID,
            dataType: "jsonp",
            error: REVIEW.proListError
        });
    },
