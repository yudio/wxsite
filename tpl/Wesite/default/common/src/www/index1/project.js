        ...
        m.extend = m.fn.extend = function () {
            ...
            u,
            a;
            typeof e == "boolean" && (i = e, e = arguments[1] || {}, n = 2),
        ...
        function () {
            ...
            if (!(!o || !o.length || !u)) {
                ...
                t.removeChild(n),
                r.attachEvent && r.fireEvent && (r.attachEvent("onclick", function l() {
        ...
        m.extend({
                ...
                dequeue : function (e, t) {
                    ...
                    r && (t === "fx" && n.unshift("inprogress"), r.call(e, function () {
                                m.dequeue(e, t)
                            }))
                }
            }),
        ...
        m.event = {
                            ...
                            for (t = t.split(" "); i = t[s++]; ) {
                                ...
                                if (l = p[i])
                                    if (n) {
                                        ...
                                        if (l.length === 0 || r != null && l.length === 1)
                                            (!f.teardown || f.teardown.call(e, u) === !1) && J(e, i, h.handle), delete p[i]
                                    } else
            ...
            trigger : function (e, n, r, i) {
                ...
                if (!i) {
                    ...
                    r || (e.stopPropagation(), m.event.global[s] && m.each(m.cache, function () {
        ...
        m.fn.extend({
                ...
                remove : function (e, t) {
                    for (var n = 0, r; (r = this[n]) != null; n++)
                        if (!e || m.filter(e, [r]).length)
                            !t && r.nodeType === 1 && (m.cleanData(r.getElementsByTagName("*")), m.cleanData([r])), r.parentNode && r.parentNode.removeChild(r);
                    return this
                },
                empty : function () {
        ...
        m.fn.extend({
                load : function (e, t, n) {
                    ...
                    return m.ajax({
                            ...
                            complete : function (e, t) {
                                (t === "success" || t === "notmodified") && s.html(i ? m("<div />").append(e.responseText.replace(_t, "")).find(i) : e.responseText),
                ...
                serializeArray : function () {
                    return this.map(function () {
                            ...
                            return e = m(this).val(),
                            e == null ? null : m.isArray(e) ? m.map(e, function (e) {
                                    return {
                                        name : t.name,
                                        value : e
                                    }
        ...
        m.extend({
                ...
                ajax : function (n) {
                    ...
                    var u = m.extend(!0, {}, m.ajaxSettings, n),
                    a,
                    f,
                    l,
                    c = n && n.context || u,
                    ...
                    if (E) {
                        ...
                        try {
                            (u.data || n && n.contentType) && E.setRequestHeader("Content-Type", u.contentType),
    ...
    return {
        ...
        embedSWF : function (n, r, i, s, o, u, a, f, l) {
            ...
            if (j(o)) {
                ...
                u && !y && j("6.0.65") && (b.win || b.mac) && (y = !0, I(r, !1), x(function () {
                            var e = {};
