...
class WxuserModel extends Model{
	...
	protected $_auto = array (
		...
		array('tpltypeid','0',self::MODEL_INSERT),
		array('tpllistid','0',self::MODEL_INSERT),
		array('tplcontentid','0',self::MODEL_INSERT),
        array('tplchid','0',self::MODEL_INSERT),
        array('tplmenuid','0',self::MODEL_INSERT),
		array('tpltypename','index',self::MODEL_INSERT),
		array('tpllistname','list',self::MODEL_INSERT),
		array('tplcontentname','detail',self::MODEL_INSERT),
        array('tplchname','channel',self::MODEL_INSERT),
        array('tplmenuname','menu',self::MODEL_INSERT),
